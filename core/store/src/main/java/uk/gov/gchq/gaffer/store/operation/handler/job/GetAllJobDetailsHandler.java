...
public class GetAllJobDetailsHandler implements OutputOperationHandler<GetAllJobDetails, CloseableIterable<JobDetail>> {
    @Override
    public CloseableIterable<JobDetail> doOperation(final GetAllJobDetails operation, final Context context, final AbstractStore store) throws OperationException {
