...
public abstract class MapReduceOperation<INPUT, OUTPUT> extends AbstractOperation<INPUT, OUTPUT> {
     ...
     * For Avro data see {@link uk.gov.gchq.gaffer.operation.simple.hdfs.handler.job.initialiser.AvroJobInitialiser}.
     * For Text data see {@link uk.gov.gchq.gaffer.operation.simple.hdfs.handler.job.initialiser.TextJobInitialiser}.
     */
