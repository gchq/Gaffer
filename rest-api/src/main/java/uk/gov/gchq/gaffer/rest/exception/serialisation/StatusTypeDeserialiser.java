...
public class StatusTypeDeserialiser extends JsonDeserializer<StatusType> {
    ...
    @Override
    public StatusType deserialize(final JsonParser jsonParser, final DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
