...
import uk.gov.gchq.gaffer.doc.dev.walkthrough.OperationChains;
...
public class LoadAndQuery6Test {
    private static final String RESOURCE_EXAMPLE_PREFIX = "6/";
    ...
    public void shouldReturnExpectedStringsViaJson() throws OperationException, SerialisationException {
        ...
        final OperationChain<CloseableIterable<String>> queryOpChain = serialiser.deserialise(StreamUtil.openStream(AbstractWalkthrough.class, RESOURCE_EXAMPLE_PREFIX + "json/query.json"), OperationChain.class);
