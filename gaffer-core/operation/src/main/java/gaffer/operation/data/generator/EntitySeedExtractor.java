...
package gaffer.operation.data.generator;
...
/**
 * Generates {@link gaffer.operation.data.ElementSeed}s from and {@link gaffer.data.element.Element}s.
 ...
 * getObject(Element) is not supported with {@link gaffer.data.element.Entity}s - an
...
public class EntitySeedExtractor extends OneToOneElementGenerator<EntitySeed> {
    ...
    /**
     * @param element the element to convert to {@link gaffer.operation.data.EntitySeed}.
     * @return the {@link gaffer.operation.data.EntitySeed} extracted from the element
     */
