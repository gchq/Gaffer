...
public class PostAggregationFilterProcessorTest {
    ...
    public void shouldFilterOutInvalidEdge() throws OperationException, SerialisationException {
        ...
        assertFalse(processor.test(CellUtil.getLazyCell(new Edge.Builder().group(TestGroups.EDGE, "validPreAggVertex", "dest", true), serialisation)));
    ...
    public void shouldNotFilterOutValidEdge() throws OperationException, SerialisationException {
        ...
        // When / Then
        assertTrue(processor.test(CellUtil.getLazyCell(new Edge.Builder().group(TestGroups.EDGE, "validPostAggVertex", "dest", true), serialisation)));
    }
