 ...
 */
public class AccumuloRangeIDRetriever extends AccumuloItemRetriever {

    private final Operation operation;

    private DirectedType directedType;

    public AccumuloRangeIDRetriever(final AccumuloStore store, final Operation operation, final View view,
                                    final DirectedType directedType, final User user)
     ...
     */
    public AccumuloRangeIDRetriever(final AccumuloStore store, final Operation operation, final View view, final User user,
                                    final IteratorSetting... iteratorSettings)
            throws StoreException {
        super(store, operation, view, user, true, iteratorSettings);
    ...
    protected void addToRanges(final Object seed, final Set<Range> ranges) throws RangeFactoryException {
        ranges.add(rangeFactory.getRangeFromPair((Pair<ElementId, ElementId>) seed, operation, view, directedType));
    }
}
