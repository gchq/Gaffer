...
public class CoreKeyGroupByAggregatorIteratorTest {
    ...
    private static final AccumuloProperties PROPERTIES = AccumuloProperties.loadStoreProperties(StreamUtil
            .storeProps(CoreKeyGroupByAggregatorIteratorTest.class));
    private static final AccumuloProperties CLASSIC_PROPERTIES = AccumuloProperties
            .loadStoreProperties(StreamUtil.openStream(CoreKeyGroupByAggregatorIteratorTest.class, "/accumuloStoreClassicKeys.properties"));
    ...
    private void testAggregatingMultiplePropertySets(final AccumuloStore store, final AccumuloElementConverter elementConverter) throws StoreException, AccumuloElementConversionException {
        ...
        try {
            ...
            // Accumulo values
            final Value value1 = elementConverter.getValueFromProperties(TestGroups.EDGE, edge
                    .getProperties());
            final Value value2 = elementConverter.getValueFromProperties(TestGroups.EDGE, edge2
                    .getProperties());
            final Value value3 = elementConverter.getValueFromProperties(TestGroups.EDGE, edge3
                    .getProperties());
            ...
            final Scanner scanner = store.getConnection()
                                         .createScanner(store.getProperties()
                                                             .getTable(), authorizations);
            ...
            final Element readEdge = elementConverter.getFullElement(entry.getKey(), entry
                    .getValue());

            final Edge expectedEdge = new Edge.Builder().group(TestGroups.EDGE)
                                                        .source("1")
                                                        .destination("2")
                                                        .directed(true)
    ...
    public void testAggregatingEmptyColumnQualifier(final AccumuloStore store, final AccumuloElementConverter elementConverter) throws StoreException, AccumuloElementConversionException {
        ...
        try {
            ...
            Edge expectedEdge = new Edge.Builder().group(TestGroups.EDGE)
                                                  .source("1")
                                                  .destination("2")
                                                  .directed(true)
                                                  .property(AccumuloPropertyNames.COLUMN_QUALIFIER, 8)
    ...
    public void shouldPartiallyAggregateColumnQualifierOverCQ1GroupBy(final AccumuloStore store, final AccumuloElementConverter elementConverter) throws StoreException, AccumuloElementConversionException {
        ...
        try {
            ...
            //THIS EDGE WILL BE REDUCED MEANING ITS CQ (columnQualifier) will only occur once because its key is equal.
            final Edge edge4 = new Edge.Builder().group(TestGroups.EDGE)
                                                 .source("1")
                                                 .destination("2")
                                                 .directed(true)
            ...
            final Edge edge5 = new Edge.Builder().group(TestGroups.EDGE)
                                                 .source("1")
                                                 .destination("2")
                                                 .directed(true)
            ...
            final Edge edge6 = new Edge.Builder().group(TestGroups.EDGE)
                                                 .source("1")
                                                 .destination("2")
                                                 .directed(true)
            ...
            final Value value3 = elementConverter.getValueFromProperties(TestGroups.EDGE, edge3
                    .getProperties());
            final Value value4 = elementConverter.getValueFromProperties(TestGroups.EDGE, edge4
                    .getProperties());
            final Value value5 = elementConverter.getValueFromProperties(TestGroups.EDGE, edge5
                    .getProperties());
            final Value value6 = elementConverter.getValueFromProperties(TestGroups.EDGE, edge6
                    .getProperties());
            ...
            m2.put(key2.getColumnFamily(), key2.getColumnQualifier(), new ColumnVisibility(key2
                    .getColumnVisibility()), key2.getTimestamp(), value2);
            final Mutation m3 = new Mutation(key.getRow());
            m3.put(key3.getColumnFamily(), key3.getColumnQualifier(), new ColumnVisibility(key3
                    .getColumnVisibility()), key3.getTimestamp(), value3);
            final Mutation m4 = new Mutation(key.getRow());
            m4.put(key4.getColumnFamily(), key4.getColumnQualifier(), new ColumnVisibility(key4
                    .getColumnVisibility()), key4.getTimestamp(), value4);
            final Mutation m5 = new Mutation(key.getRow());
            m5.put(key5.getColumnFamily(), key5.getColumnQualifier(), new ColumnVisibility(key5
                    .getColumnVisibility()), key5.getTimestamp(), value5);
            final Mutation m6 = new Mutation(key.getRow());
            m6.put(key6.getColumnFamily(), key6.getColumnQualifier(), new ColumnVisibility(key6
                    .getColumnVisibility()), key6.getTimestamp(), value6);
            ...
            Edge expectedEdge1 = new Edge.Builder().group(TestGroups.EDGE)
                                                   .source("1")
                                                   .destination("2")
                                                   .directed(true)
                                                   .property(AccumuloPropertyNames.COLUMN_QUALIFIER, 1)
            ...
            Edge expectedEdge2 = new Edge.Builder().group(TestGroups.EDGE)
                                                   .source("1")
                                                   .destination("2")
                                                   .directed(true)
                                                   .property(AccumuloPropertyNames.COLUMN_QUALIFIER, 2)
            ...
            Edge expectedEdge3 = new Edge.Builder().group(TestGroups.EDGE)
                                                   .source("1")
                                                   .destination("2")
                                                   .directed(true)
                                                   .property(AccumuloPropertyNames.COLUMN_QUALIFIER, 3)
            ...
            Edge expectedEdge4 = new Edge.Builder().group(TestGroups.EDGE)
                                                   .source("1")
                                                   .destination("2")
                                                   .directed(true)
                                                   .property(AccumuloPropertyNames.COLUMN_QUALIFIER, 4)
