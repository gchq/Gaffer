...
public class TimestampSetElementGenerator implements OneToManyElementGenerator<String> {
    ...
    private static final Instant INSTANT = ZonedDateTime.of(2017, 1, 1, 1, 1, 1, 0, ZoneId.of("UTC")).toInstant();
    ...
    public Iterable<Element> _apply(final String line) {
        ...
        for (int i = 0; i < 25; i++) {
            ...
            final Instant instant = INSTANT.plusSeconds(RANDOM.nextInt(SECONDS_IN_YEAR));
