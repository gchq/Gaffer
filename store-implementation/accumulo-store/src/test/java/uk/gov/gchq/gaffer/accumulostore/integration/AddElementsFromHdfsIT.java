...
import uk.gov.gchq.gaffer.operation.hdfs.handler.job.initialiser.TextJobInitialiser;
import uk.gov.gchq.gaffer.operation.hdfs.mapper.generator.TextMapperGenerator;
