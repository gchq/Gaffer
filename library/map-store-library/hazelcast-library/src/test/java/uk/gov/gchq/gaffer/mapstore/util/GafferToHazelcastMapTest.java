...
public class GafferToHazelcastMapTest {
    ...
    public void shouldDelegateAllCallsToMap() throws StoreException {
        ...
        final IMap<String, String> map = mock(IMap.class);
        ...
        final GafferToHazelcastMap<String, String> wrapper = new GafferToHazelcastMap<>(map);
        ...
        // When / Then - getMap
        final IMap<String, String> mapResult = wrapper.getMap();
