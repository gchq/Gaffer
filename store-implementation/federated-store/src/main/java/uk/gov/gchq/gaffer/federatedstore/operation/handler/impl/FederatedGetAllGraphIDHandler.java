...
public class FederatedGetAllGraphIDHandler implements OutputOperationHandler<GetAllGraphIds, Iterable<? extends String>>, OperationValidation<GetAllGraphIds> {
