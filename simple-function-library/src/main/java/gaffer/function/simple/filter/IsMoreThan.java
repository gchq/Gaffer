...
/**
 * An <code>IsMoreThan</code> is a {@link gaffer.function.SingleInputFilterFunction} that checks that the input
...
public class IsMoreThan extends SingleInputFilterFunction {
