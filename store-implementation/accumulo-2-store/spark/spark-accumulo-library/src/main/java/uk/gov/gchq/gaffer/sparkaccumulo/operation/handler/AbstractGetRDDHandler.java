...
public abstract class AbstractGetRDDHandler<OP extends Output<O> & GraphFilters, O>
    ...
    public <INPUT_OP extends Operation & GraphFilters & Input<Iterable<? extends ElementId>>> void addRanges(final AccumuloStore accumuloStore,
                                                                                                             final Configuration conf,
    ...
    public <INPUT_OP extends Operation & GraphFilters & Input<Iterable<? extends Pair<? extends ElementId, ? extends ElementId>>>> void addRangesFromPairs(final AccumuloStore accumuloStore,
                                                                                                                                                           final Configuration conf,
                                                                                                                                                           final INPUT_OP operation)
            throws OperationException {
        final List<Range> ranges = new ArrayList<>();
