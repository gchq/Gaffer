...
/**
 * Given two sets of {@link EntityId}s, called A and B,
 * this retrieves all {@link Edge}s where one end is in set
 * A and the other is in set B and also returns
 * {@link Entity}s for
 * {@link EntityId}s in set A.
 * <p>
 * This is done by querying for set A, and uses a
 * {@link BloomFilter}s in a filtering iterator to
 ...
 * a {@link BloomFilter}. This is passed to the
 ...
 * {@link BloomFilter} check in the iterators).
 ...
 * into two {@link BloomFilter}s. The first of
 ...
 * {@link BloomFilter} is used client-side to
