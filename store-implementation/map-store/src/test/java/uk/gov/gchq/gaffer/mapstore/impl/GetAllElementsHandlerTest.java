    ...
    public static List<Element> getElements() {
        ...
        IntStream.range(0, NUM_LOOPS)
                .forEach(i -> {
                    ...
                    elements.add(entity);
                    final Edge edge1 = new Edge.Builder().group(BASIC_EDGE1, "A", "B" + i, true);
                    edge1.putProperty(PROPERTY1, "q");
                    edge1.putProperty(COUNT, i);
                    elements.add(edge1);
                    final Edge edge2 = new Edge.Builder().group(BASIC_EDGE2, "X", "Y" + i, false);
                    edge2.putProperty(PROPERTY1, "r");
                    edge2.putProperty(PROPERTY2, "s");
