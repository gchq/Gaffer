...
/**
 * A <code>ConsumerFunctionContext</code> wraps a {@link gaffer.function.ConsumerFunction}, and provides the
 * references to select data from an input {@link gaffer.function.Tuple} so they can be consumed by the function.
 *
...
public class ConsumerFunctionContext<R, F extends ConsumerFunction> extends FunctionContext<F> {
    ...
    /**
     * Create a <code>ConsumerFunctionContext</code> that selects data from input {@link gaffer.function.Tuple}s using
     * the specified selection references to pass arguments to the {@link gaffer.function.ConsumerFunction}.
     *
     * @param function  {@link gaffer.function.ConsumerFunction} to be wrapped by the context.
    ...
    /**
     * @return References to select data from an input {@link gaffer.function.Tuple}.
     */
    ...
    /**
     * @param selection References to select data from an input {@link gaffer.function.Tuple}.
     */
    ...
    /**
     * Implementation of the Builder pattern for {@link gaffer.function.context.ConsumerFunctionContext}.
     *
    ...
    public static class Builder<R, F extends ConsumerFunction> extends FunctionContext.Builder<F> {
        ...
        /**
         * Create a <code>Builder</code> to configure a new {@link gaffer.function.context.ConsumerFunctionContext}.
         */
        public Builder() {
        ...
        /**
         * Create a <code>Builder</code> to configure a {@link gaffer.function.context.ConsumerFunctionContext}.
         *
         * @param context {@link gaffer.function.context.ConsumerFunctionContext} to be configured.
         */
        ...
        /**
         * Sets the references to be used by the {@link gaffer.function.context.ConsumerFunctionContext} to select
         * input data and returns this <code>Builder</code> for further configuration.
         *
         * @param newSelection References to select data from an input {@link gaffer.function.Tuple}.
