...
/**
 * {@link ISchemaLoader} implementation to load a {@link uk.gov.gchq.gaffer.store.schema.Schema}s
 * featuring aggregation properties for testing purposes.
 */
public class AggregationSchemaLoader implements ISchemaLoader {
