...
import uk.gov.gchq.gaffer.doc.properties.generator.HyperLogLogPlusElementGenerator;
...
public class HyperLogLogPlusWalkthrough extends PropertiesWalkthrough {
    ...
    public static void main(final String[] args) throws OperationException {
        new HyperLogLogPlusWalkthrough().run();
    }
    ...
    public CloseableIterable<? extends Element> run() throws OperationException {
        ...
        final Graph graph = new Graph.Builder()
                ...
                .addSchemas(StreamUtil.openStreams(getClass(), "properties/hyperLogLogPlus/schema"))
        ...
        // ---------------------------------------------------------
        log("Added 1000 entities for vertex A, each time with a HyperLogLogPlus containing a vertex that A was seen in an"
                + "edge with");
