...
public abstract class CoreKeyColumnQualifierColumnVisibilityValueCombiner extends WrappingIterator implements OptionDescriber {
    ...
    /**
     * Sets the topKey and topValue based on the top gaffer.accumulostore.key of the source.
     */
     ...
     * @param iter An iterator over the Values for different versions of the gaffer.accumulostore.key.
