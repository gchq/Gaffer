...
public class HBaseProperties extends StoreProperties {
    ...
    public static final String KEY_PACKAGE_CLASS = "gaffer.store.hbase.keypackage.class";
    ...
    public static final String THREADS_FOR_BATCH_SCANNER = "hbase.batchScannerThreads";
    public static final String MAX_ENTRIES_FOR_BATCH_SCANNER = "hbase.entriesForBatchScanner";
    public static final String CLIENT_SIDE_BLOOM_FILTER_SIZE = "hbase.clientSideBloomFilterSize";
    public static final String FALSE_POSITIVE_RATE = "hbase.falsePositiveRate";
    public static final String MAX_BLOOM_FILTER_TO_PASS_TO_AN_ITERATOR = "hbase.maxBloomFilterToPassToAnIterator";
    public static final String MAX_BUFFER_SIZE_FOR_BATCH_WRITER = "hbase.maxBufferSizeForBatchWriterInBytes";
    public static final String MAX_TIME_OUT_FOR_BATCH_WRITER = "hbase.maxTimeOutForBatchWriterInMilliseconds";
    public static final String NUM_THREADS_FOR_BATCH_WRITER = "hbase.numThreadsForBatchWriter";
    public static final String TABLE_REPLICATION_FACTOR = "hbase.file.replication";
    public static final String ENABLE_VALIDATOR_ITERATOR = "gaffer.store.hbase.enable.validator.iterator";
    ...
    /**
     * Gets the number of threads that should be used for the hbase batch
     * writers
     *
    ...
    /**
     * Gets the time out/latency that should be used for the hbase batch
     * writers
     *
    ...
    /**
     * Gets the memory buffer size that should be used for the hbase batch
     * writers
     *
     * @return The buffer size in bytes to use in the batch writer
     */
    public int getMaxBufferSizeForBatchWriter() {
        return Integer.parseInt(get(MAX_BUFFER_SIZE_FOR_BATCH_WRITER, MAX_BUFFER_SIZE_FOR_BATCH_WRITER_DEFAULT));
    }
     ...
     * not set then the table will use your general hbase settings default
     * value.
     *
     ...
     * value.
     *
     * @param replicationFactor the replication factor to be applied to tables created by gaffer, if not set then the table will use your general hbase settings default value.
     */
