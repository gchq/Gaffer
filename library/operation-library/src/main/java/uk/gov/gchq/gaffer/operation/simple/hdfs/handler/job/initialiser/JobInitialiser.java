 ...
 */
package uk.gov.gchq.gaffer.operation.simple.hdfs.handler.job.initialiser;
...
public interface JobInitialiser {
     ...
     * @param operation the {@link uk.gov.gchq.gaffer.operation.simple.hdfs.operation.AddElementsFromHdfs} containing configuration.
     * @param store     the {@link uk.gov.gchq.gaffer.store.Store} that will handle the {@link uk.gov.gchq.gaffer.operation.Operation}
