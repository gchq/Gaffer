...
import static uk.gov.gchq.gaffer.federatedstore.operation.handler.impl.FederatedAddSchemaHandler.THE_STORE_DOESN_T_HAVE_A_GRAPH_LIBRARY;
...
public class FederatedAddSchemaHandlerTest {
    ...
    public void shouldThrowWithNoGraphLibrary() throws Exception {
        ...
        try {
            ...
            assertTrue(e.getMessage().contains(String.format(ERROR_ADDING_SCHEMA_TO_FEDERATED_STORE_S, THE_STORE_DOESN_T_HAVE_A_GRAPH_LIBRARY)));
        }
    }
