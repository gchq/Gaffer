...
public abstract class AbstractGenerateSplitPointsFromSampleHandlerTest<S extends Store> {
    ...
    public void shouldThrowExceptionForNullInput() throws OperationException {
        ...
        // When + Then
        Exception e1 = assertThrows(OperationException.class, () -> handler.doOperation(operation, new Context(), createStore()));
        final String expected = "Operation input is required.";
