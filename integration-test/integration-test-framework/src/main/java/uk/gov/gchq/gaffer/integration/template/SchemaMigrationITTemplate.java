...
public class SchemaMigrationITTemplate extends AbstractStoreIT {
    ...
    @GafferTest
    public void shouldMigrateOldToNew(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
    ...
    @TraitRequirement(StoreTrait.TRANSFORMATION)
    @GafferTest
    public void shouldMigrateNewToNew(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.NEW);
    ...
    @TraitRequirement(StoreTrait.TRANSFORMATION)
    @GafferTest
    public void shouldMigrateOldAndNewToNew(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.NEW);
    ...
    @TraitRequirement(StoreTrait.TRANSFORMATION)
    @GafferTest
    public void shouldMigrateOldToOld(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
    ...
    @TraitRequirement(StoreTrait.TRANSFORMATION)
    @GafferTest
    public void shouldMigrateNewToOld(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.OLD);
    ...
    @TraitRequirement(StoreTrait.TRANSFORMATION)
    @GafferTest
    public void shouldMigrateOldAndNewToOld(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.OLD);
    ...
    @GafferTest
    public void shouldMigrateOldToNewWithAgg(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.NEW);
    ...
    @TraitRequirement(StoreTrait.TRANSFORMATION)
    @GafferTest
    public void shouldCorrectlyApplyPostAggFiltering(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.NEW);
    ...
    @TraitRequirement(StoreTrait.TRANSFORMATION)
    @GafferTest
    public void shouldApplyPostOpAggregation(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.NEW);
    ...
    @TraitRequirement(StoreTrait.TRANSFORMATION)
    @GafferTest
    public void shouldAggBeforePostFilters(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.OLD);
        migration.setAggregateAfter(true);
    ...
    @GafferTest
    public void shouldAddOperationsAfterEachGetElements(final GafferTestCase testcase) throws OperationException {
        Graph graph = createGraph(testcase.getStoreProperties());
        migration.setOutputType(SchemaMigration.MigrationOutputType.NEW);
    ...
    private Graph createGraph(final StoreProperties storeProperties) throws OperationException {
        return addExtraElements(new Graph.Builder()
    ...
    private Graph addExtraElements(final Graph graph) throws OperationException {
