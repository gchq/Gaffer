...
public abstract class AbstractWalkthrough {
    ...
    public String walkthrough() throws OperationException {
        ...
        try (final InputStream stream = StreamUtil.openStream(getClass(), "walkthrough/" + exampleId + ".md")) {
            if (null == stream) {
    ...
    protected InputStream getData() {
        return StreamUtil.openStream(getClass(), dataPath, true);
    }

    protected InputStream[] getSchemas() {
        return StreamUtil.openStreams(getClass(), schemaPath, true);
    }

    protected InputStream getStoreProperties() {
        return StreamUtil.openStream(getClass(), storePropertiesLocation, true);
    }
}
