...
import uk.gov.gchq.gaffer.doc.dev.walkthrough.Visibilities;
...
public class LoadAndQuery5Test {
    private static final String RESOURCE_EXAMPLE_PREFIX = "5/";
    ...
    public void shouldReturnExpectedEdges() throws OperationException {
        // Given
        final Visibilities query = new Visibilities();
