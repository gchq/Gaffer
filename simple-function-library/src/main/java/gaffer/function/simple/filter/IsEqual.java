...
/**
 * An <code>IsEqual</code> is a {@link gaffer.function.SingleInputFilterFunction} that checks that the input object is
 * equal to a control value.
 */
@Inputs(Object.class)
public class IsEqual extends SingleInputFilterFunction {
