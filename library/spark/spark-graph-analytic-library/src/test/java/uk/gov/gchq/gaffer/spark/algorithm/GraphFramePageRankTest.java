...
public class GraphFramePageRankTest extends OperationTest<PageRank<GraphFrame>> {

    @Test
    public void shouldInvalidateOperationIfMaxIterationsAndToleranceAreSet() {
        // Given
        final GraphFramePageRank op = new GraphFramePageRank.Builder()
    ...
    @Override
    protected GraphFramePageRank getTestObject() {
