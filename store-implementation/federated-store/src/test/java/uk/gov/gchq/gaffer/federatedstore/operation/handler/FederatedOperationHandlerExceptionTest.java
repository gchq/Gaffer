...
public class FederatedOperationHandlerExceptionTest {

    @Test(expected = OperationException.class)
    public void shouldThrowException() throws Exception {

        FederatedOperationOutputHandler<GetAllElements, CloseableIterable<? extends Element>> opHandler = new FederatedOperationOutputHandler<GetAllElements, CloseableIterable<? extends Element>>() {
            @Override
