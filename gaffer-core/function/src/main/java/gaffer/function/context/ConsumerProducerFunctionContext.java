...
/**
 * A <code>ConsumerProducerFunctionContext</code> extends a {@link gaffer.function.context.ConsumerFunctionContext} to
 * wrap a {@link gaffer.function.ConsumerProducerFunction} and also provide the references to project the results
 * produced by the function into an output {@link gaffer.function.Tuple}.
 *
...
public class ConsumerProducerFunctionContext<R, F extends ConsumerProducerFunction> extends ConsumerFunctionContext<R, F> {
     ...
     * {@link gaffer.function.ConsumerProducerFunction}, using the specified selection and projection references.
     *
    ...
    /**
     * Implementation of the Builder pattern for {@link gaffer.function.context.ConsumerProducerFunctionContext}.
     *
    ...
    public static class Builder<R, F extends ConsumerProducerFunction> extends ConsumerFunctionContext.Builder<R, F> {
         ...
         * {@link gaffer.function.context.ConsumerProducerFunctionContext}.
         */
        public Builder() {
         ...
         * {@link gaffer.function.context.ConsumerProducerFunctionContext}.
         *
         * @param context {@link gaffer.function.context.ConsumerProducerFunctionContext} to be configured.
         */
        ...
        /**
         * Sets the references to be used by the {@link gaffer.function.context.ConsumerProducerFunctionContext} to
