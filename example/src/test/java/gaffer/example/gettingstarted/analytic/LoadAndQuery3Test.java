...
public class LoadAndQuery3Test {
    private static final String RESOURCE_PREFIX = "/example/gettingstarted/";
    private static final String RESOURCE_EXAMPLE_PREFIX = RESOURCE_PREFIX + "3/";
    ...
    public void shouldReturnExpectedEdges() throws OperationException {
        // Given
        final LoadAndQuery3 query = new LoadAndQuery3();
    ...
    public void shouldReturnExpectedEdgesViaJson() throws OperationException, SerialisationException {
        ...
        final Graph graph = new Graph.Builder()
                .storeProperties(StreamUtil.openStream(getClass(), RESOURCE_PREFIX + "mockaccumulostore.properties"))
