...
public class AccumuloRangeIDRetriever
        extends AccumuloItemRetriever<SeededGraphGet<Pair<ElementId>, ?>, Pair<ElementId>> {

    public AccumuloRangeIDRetriever(final AccumuloStore store, final SeededGraphGet<Pair<ElementId>, ?> operation,
                                    final User user)
