...
public class ProxyGraphResetter implements BeforeEachCallback {

    @Override
    public void beforeEach(final ExtensionContext extensionContext) throws Exception {
        GraphFactory graphFactory = SpringExtension.getApplicationContext(extensionContext).getBeanProvider(GraphFactory.class).getObject();
