...
/**
 * An {@link OperationHandler} for the {@link GetElements} operation on the {@link MapStore}. It simply delegates
 * the operation to the {@link MapStore#getElements} method.
 */
public class GetElementsOperationHandler
    ...
    private CloseableIterable<Element> doOperation(final GetElements<ElementSeed, Element> operation,
                                                   final MapStore store) throws OperationException {
        return store.getElements(operation);
    }
}
