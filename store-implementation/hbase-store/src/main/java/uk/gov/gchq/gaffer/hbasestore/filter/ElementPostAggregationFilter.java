...
public class ElementPostAggregationFilter extends AbstractElementFilter {
    ...
    public ElementPostAggregationFilter(final Schema schema, final View view) {
        super(schema, new ElementValidator(view));
        this.view = view;
    }

    public static ElementPostAggregationFilter parseFrom(final byte[] pbBytes) throws DeserializationException {
        ...
        return new ElementPostAggregationFilter(props.getSchema(), props.getView());
    }
