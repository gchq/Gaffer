...
public abstract class SchemaElementDefinitionTest<T extends SchemaElementDefinition> {
    ...
    public void shouldNotBeAbleToAddPropertiesOnceBuilt() {
        ...
        // When / Then
        assertThrows(UnsupportedOperationException.class, () -> elementDef.getPropertyMap().put("new property", "string"));
    }
    ...
    public void shouldNotBeAbleToAddIdentifiersOnceBuilt() {
        ...
        // When / Then
        assertThrows(UnsupportedOperationException.class, () -> elementDef.getIdentifierMap().put(IdentifierType.SOURCE, "string"));
    }
    ...
    public void shouldNotBeAbleToModifyGroupByOnceBuilt() {
        ...
        // When / Then
        assertThrows(UnsupportedOperationException.class, () -> elementDef.getGroupBy().add("property"));
    }
    ...
    public void shouldNotBeAbleToModifyParentsOnceBuilt() {
        ...
        // When / Then
        assertThrows(UnsupportedOperationException.class, () -> elementDef.getParents().add("parentGroup2"));
    }
    ...
    public void shouldReturnFullAggregator() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> aggregator.getComponents().add(null));
    ...
    public void shouldThrowExceptionWhenMergeSchemaElementDefinitionWithConflictingProperty() {
        ...
        // When / Then
        final Exception exception = assertThrows(SchemaException.class, () -> createEmptyBuilder()
                .merge(elementDef1)
                .merge(elementDef2)
                .build());
        final String expected = "Unable to merge element definitions because the property property1 exists in both definitions with different types: string and int";
