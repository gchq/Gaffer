 ...
 * 
 */
public class GetElementsInRanges<SEED_TYPE extends ElementSeed, ELEMENT_TYPE extends Element> extends AbstractGetOperationWithPair<SEED_TYPE, ELEMENT_TYPE> {
