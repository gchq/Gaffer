...
import gaffer.rest.service.IExamplesService;
...
public class SimpleExamplesService2 implements IExamplesService {
    private final GraphFactory graphFactory;

    public SimpleExamplesService2() {
        this(new GraphFactory(true));
    }

    public SimpleExamplesService2(final GraphFactory graphFactory) {
