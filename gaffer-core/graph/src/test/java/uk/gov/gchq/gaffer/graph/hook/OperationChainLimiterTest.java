...
public class OperationChainLimiterTest {
    ...
    private static final OperationChainLimiter OPERATION_CHAIN_LIMITER = new OperationChainLimiter(StreamUtil
            .opScores(OperationChainLimiterTest.class), StreamUtil.authScores(OperationChainLimiterTest.class));
