...
public final class TestUtil {
    ...
    public static <T> T jsonClone(final T object) {
        try {
            return (T) JSONSerialiser.deserialise(JSONSerialiser.serialise(object), object.getClass());
        } catch (final IOException e) {
            throw new RuntimeException("Failed to Serialise object", e);
        }
    }
