...
import uk.gov.gchq.koryphe.iterable.FederatedChainedIterable;
 ...
 */
@Deprecated
public class FederatedIterableConcat<I_ITEM> extends KorypheFunction<Iterable<Iterable<I_ITEM>>, Iterable<I_ITEM>> {
    @Override
    public Iterable<I_ITEM> apply(final Iterable<Iterable<I_ITEM>> items) {
        return new FederatedChainedIterable<>(items);
    }
}
