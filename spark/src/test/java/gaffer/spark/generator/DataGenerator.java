...
package gaffer.spark.generator;

import gaffer.data.element.Edge;
import gaffer.data.element.Element;
import gaffer.data.element.Entity;
import gaffer.data.generator.OneToOneElementGenerator;
import gaffer.spark.data.Film;
import gaffer.spark.data.Person;
import gaffer.spark.data.Review;
import gaffer.spark.data.Viewing;
import gaffer.spark.data.schema.Group;
