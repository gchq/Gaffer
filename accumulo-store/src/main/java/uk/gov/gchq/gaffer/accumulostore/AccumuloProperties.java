...
public class AccumuloProperties extends StoreProperties {
    ...
    public static final String KEY_PACKAGE_CLASS = "uk.gov.gchq.gaffer.store.accumulo.keypackage.class";
    ...
    public static final String ENABLE_VALIDATOR_ITERATOR = "uk.gov.gchq.gaffer.store.accumulo.enable.validator.iterator";
