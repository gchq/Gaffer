...
public class MapAggregatorTest {
    ...
    public void testMapAggregation() {
        ...
        Aggregator<Integer, Integer> aggregator = mock(Aggregator.class);
        for (int i = 0; i < noInputs; i++) {
        ...
        MapAggregator<String, Integer, Integer> mapAggregator = new MapAggregator<>();
        mapAggregator.setAggregator(aggregator);
