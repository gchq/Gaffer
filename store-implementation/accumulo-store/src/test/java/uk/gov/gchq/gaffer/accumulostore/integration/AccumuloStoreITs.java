...
//        singleTest(GraphAlgorithmsIT.class, "shouldGetPaths");
        singleTest(GraphAlgorithmsIT.class, "shouldGetPathsWithPreFiltering_1");
//        singleTest(GraphAlgorithmsIT.class, "shouldGetPathsWithEntities");
    }
}
