...
//
// todo overhaul integration test framework
//public class ProxyStoreITs extends AbstractStoreITs {
//    private static final ProxyProperties STORE_PROPERTIES = ProxyProperties.loadStoreProperties(StreamUtil.openStream(ProxyStoreITs.class, "/proxy-store.properties"));
//
