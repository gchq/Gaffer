...
public class FullInnerJoinTest extends JoinFunctionTest {

    @Override
    protected Set<Map<Element, List<Element>>> getExpectedLeftKeyResults() {
        return Sets.newHashSet(ImmutableMap.of(getElement(1), Collections.singletonList(getElement(1))),
