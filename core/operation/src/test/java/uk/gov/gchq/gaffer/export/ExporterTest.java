...
//        // When / Then
//        try {
//            exporter.add(values, user, updateExport.getKey(), "jobId");
...
//        // When / Then
//        try {
//            exporter.add(values, null, updateExport.getKey(), "jobId");
//            fail("NotImplementedException expected");
//        } catch (final IllegalArgumentException e) {
//            assertNotNull(e.getMessage());
//        }
...
//        // When / Then
//        try {
//            exporter.add(values, user2, updateExport.getKey(), "jobId");
//            fail("NotImplementedException expected");
//        } catch (final IllegalArgumentException e) {
//            assertNotNull(e.getMessage());
//        }
