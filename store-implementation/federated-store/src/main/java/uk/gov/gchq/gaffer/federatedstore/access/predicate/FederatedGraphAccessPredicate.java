...
public abstract class FederatedGraphAccessPredicate extends DefaultAccessPredicate {

    public FederatedGraphAccessPredicate(final String creatingUserId, final List<String> auths) {
