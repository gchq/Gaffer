...
public abstract class TupleInputBinaryOperator<R, I, F extends BinaryOperator<I>> {
    @JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY, property = "class")
    protected F function;
    protected TupleMask<R, I> selection;

    public TupleInputBinaryOperator() {
    }

    public TupleInputBinaryOperator(TupleMask<R, I> selection, F function) {
