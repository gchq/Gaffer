...
public abstract class SystemProperty {
    ...
    public static final String REST_DEBUG = uk.gov.gchq.gaffer.core.exception.Error.REST_DEBUG;
    ...
    public static final String REST_DEBUG_DEFAULT =  uk.gov.gchq.gaffer.core.exception.Error.REST_DEBUG_DEFAULT;
