...
import uk.gov.gchq.gaffer.accumulostore.utils.AccumuloOperationHandlerUtils.BuilderViewDirectedType;
...
import static uk.gov.gchq.gaffer.accumulostore.utils.AccumuloOperationHandlerUtils.getViewDirectedTypeFieldDeclaration;

public class GetAllElementsHandler implements OperationHandler<Iterable<? extends Element>> {
    ...
    public Iterable<? extends Element> _doOperation(final Operation operation, final Context context, final Store store) throws OperationException {
        try {
            ...
            return new AccumuloAllElementsRetriever(accumuloStore, operation, view, directedType, context.getUser());
    ...
    public static class OperationBuilder extends BuilderViewDirectedType<OperationBuilder, GetAllElementsHandler> {
        ...
        @Override
        protected GetAllElementsHandler getHandler() {
