 ...
 */
package uk.gov.gchq.gaffer.operation.hdfs.operation;

import com.fasterxml.jackson.annotation.JsonTypeInfo;
import org.apache.hadoop.mapreduce.Partitioner;
import uk.gov.gchq.gaffer.operation.AbstractOperation;
import uk.gov.gchq.gaffer.operation.hdfs.handler.job.initialiser.JobInitialiser;
...
public abstract class MapReduceOperation<INPUT, OUTPUT> extends AbstractOperation<INPUT, OUTPUT> {
     ...
     * For Avro data see {@link uk.gov.gchq.gaffer.operation.hdfs.handler.job.initialiser.AvroJobInitialiser}.
     * For Text data see {@link uk.gov.gchq.gaffer.operation.hdfs.handler.job.initialiser.TextJobInitialiser}.
     */
