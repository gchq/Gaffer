 ...
 * GraphElementWithStatistics} contains a directed edge. Note that this predicate
 ...
 */
public class DirectedEdgePredicate implements Predicate<GraphElementWithStatistics> {

    private static final long serialVersionUID = -687462966973616272L;

    public DirectedEdgePredicate() { }
