...
/**
 * An <code>LazyEdge</code> wraps an {@link gaffer.data.element.Edge} and lazily loads identifiers and properties when
...
public class LazyEdge extends Edge {
    ...
    /**
     * Constructs a {@link gaffer.data.element.LazyEdge} by wrapping the provided {@link gaffer.data.element.Edge}
