...
/**
 * A <code>Transformer</code> is a {@link gaffer.function.processor.Processor} that applies
 * {@link gaffer.function.TransformFunction}s to {@link gaffer.function.Tuple}s, changing their contents in some
...
public class Transformer<R> extends Processor<R, ConsumerProducerFunctionContext<R, TransformFunction>> {
    /**
     * Transform an input {@link gaffer.function.Tuple} using {@link gaffer.function.TransformFunction}s.
     *
     * @param tuple {@link gaffer.function.Tuple} to be transformed.
     */
    ...
    /**
     * Create a deep copy of the {@link gaffer.function.context.ConsumerProducerFunctionContext}s executed by this
     * <code>Transformer</code>.
     *
     * @return Deep copy of {@link gaffer.function.context.ConsumerProducerFunctionContext}s.
     */
    ...
    /**
     * Implementation of the Builder pattern for {@link gaffer.function.processor.Transformer}.
     *
     * @param <R> The type of reference used by tuples.
     */
    public static class Builder<R> {
        ...
        /**
         * Create a <code>Builder</code> for a new {@link gaffer.function.processor.Transformer}.
         */
        public Builder() {
        ...
        /**
         * Create a <code>Builder</code> for a {@link gaffer.function.processor.Transformer}.
         *
         * @param transformer {@link gaffer.function.processor.Transformer} to be configured.
         */
         ...
         * {@link gaffer.function.context.ConsumerProducerFunctionContext}. If the current context already has a
        ...
        /**
         * Set the {@link gaffer.function.TransformFunction} to be executed by the current
         * {@link gaffer.function.context.ConsumerProducerFunctionContext}. If the current context already has a
         * function set, a new context is created and made current. Returns this <code>Builder</code> for further
         * configuration.
         *
         * @param function {@link gaffer.function.TransformFunction} to be executed.
         * @return This <code>Builder</code>.
         */
        ...
        /**
         * Build the {@link gaffer.function.processor.Transformer} configured by this <code>Builder</code>.
         *
         * @return Configured {@link gaffer.function.processor.Transformer}.
         */
        ...
        /**
         * Build the current {@link gaffer.function.context.ConsumerProducerFunctionContext}, add it to the
         * {@link gaffer.function.processor.Transformer} and create a new current context.
         *
         * @return This <code>Builder</code>.
         */
