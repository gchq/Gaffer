...
import uk.gov.gchq.gaffer.doc.dev.walkthrough.Cardinalities;
...
public class LoadAndQuery9Test {
    private static final String RESOURCE_EXAMPLE_PREFIX = "9/";
    ...
    public void shouldReturnExpectedEdgesViaJson() throws OperationException, SerialisationException {
        ...
        final GetAllElements getRelatedEdges = serialiser.deserialise(StreamUtil.openStream(AbstractWalkthrough.class, RESOURCE_EXAMPLE_PREFIX + "json/query.json"), GetAllElements.class);
    ...
    private void verifyResults(final CloseableIterable<? extends Element> resultsItr) {
        ...
        expectedResults.put("RoadUse", new Entity.Builder()
                .group(CARDINALITY)
                .vertex("RoadUse")
                .property(COUNT, 8)
