    ...
    public static Schema createDefaultSchema() {
        return new Schema.Builder()
                .type(TestTypes.ID_STRING, new TypeDefinition()
                        .clazz(String.class))
                .type(TestTypes.DIRECTED_EITHER, new TypeDefinition()
                        .clazz(Boolean.class))
                .type(TestTypes.PROP_SET_STRING, new TypeDefinition()
                        .clazz(TreeSet.class)
                ...
                .type(TestTypes.TIMESTAMP, new TypeDefinition()
                        .clazz(Long.class)
                        .aggregateFunction(new Max()))
                .type(TestTypes.TIMESTAMP_2, new TypeDefinition()
                        .clazz(Long.class)
                        .aggregateFunction(new Max())
                        .validateFunctions(new AgeOff(AGE_OFF_TIME)))
                .type(TestTypes.PROP_INTEGER_2, new TypeDefinition()
                        .clazz(Integer.class)
                        .aggregateFunction(new Max())
