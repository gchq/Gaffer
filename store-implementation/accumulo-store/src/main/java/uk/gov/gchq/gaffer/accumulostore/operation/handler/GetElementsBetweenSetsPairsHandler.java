...
public class GetElementsBetweenSetsPairsHandler implements OutputOperationHandler<GetElementsBetweenSetsPairs, Iterable<? extends Element>> {

    @Override
    public Iterable<? extends Element> doOperation(final GetElementsBetweenSetsPairs operation,
    ...
    public Iterable<? extends Element> doOperation(final GetElementsBetweenSetsPairs operation,
        ...
        try {
            ...
            return new AccumuloIDBetweenSetsRetriever(store, operation.getBackwardsCompatibleOperation(), user,
