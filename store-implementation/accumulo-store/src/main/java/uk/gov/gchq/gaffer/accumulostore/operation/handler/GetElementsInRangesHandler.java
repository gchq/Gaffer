...
public class GetElementsInRangesHandler implements OperationHandler<Iterable<? extends Element>> {
    ...
    public Iterable<? extends Element> _doOperation(final Operation operation, final Context context, final Store store) throws OperationException {
        try {
            ...
            return new AccumuloRangeIDRetriever(accumuloStore, operation, view, context.getUser(),
    ...
    public static class OperationBuilder extends BuilderInputInOutTypeViewDirectedType<OperationBuilder, GetElementsHandler, Iterable<? extends Pair<? extends ElementId, ? extends ElementId>>> {
