 ...
 * For the SingleUseMiniAccumuloStore each time initialise is called the underlying table as set in the store properties
 * is deleted.
 */
public class SingleUseMiniAccumuloStore extends MiniAccumuloStore {
    ...
    public void preInitialise(final String graphId, final Schema schema, final StoreProperties properties)
        ...
        // the MiniInstance and then creates the table. This ensures the getConnection() method works. The table is
