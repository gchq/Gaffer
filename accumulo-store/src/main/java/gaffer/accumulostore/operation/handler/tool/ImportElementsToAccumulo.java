...
public class ImportElementsToAccumulo extends Configured implements Tool {
    ...
    public ImportElementsToAccumulo(final AddElementsFromHdfs operation, final AccumuloStore store) throws StoreException {
    ...
    public int run(final String[] strings) throws Exception {
        ...
        // Import the files
        connector.tableOperations().importDirectory(table, operation.getOutputPath().toString(), operation.getFailurePath().toString(), false);
