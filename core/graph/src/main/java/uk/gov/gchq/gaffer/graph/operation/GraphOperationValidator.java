...
public class GraphOperationValidator extends OperationValidator {
    private final ViewValidator viewValidator = new ViewValidator();

    public GraphOperationValidator() {
    }
     ...
     */
    @Deprecated
    protected void validateComparables(final Operation op,
                                       final ValidationResult validationResult, final Schema schemaNotUsed, final Store store) {
    ...
    protected Schema getSchema(final Operation operation, final User user,
                               final Store store) {
        return ((GraphConfig) store.getConfig()).getSchema();
    }
