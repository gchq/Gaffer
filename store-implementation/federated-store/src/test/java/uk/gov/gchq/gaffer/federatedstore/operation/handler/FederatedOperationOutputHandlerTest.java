...
public abstract class FederatedOperationOutputHandlerTest<OP extends Output<O>, O> {
    ...
    public void shouldMergeResultsFromFieldObjects() throws Exception {
        ...
        Mockito.when(mockStore.getGraphs(user, null, null)).thenReturn(linkedGraphs);
    ...
    public void shouldMergeResultsFromFieldObjectsWithGivenGraphIds() throws Exception {
        ...
        Mockito.when(mockStore.getGraphs(user, "1,3", null)).thenReturn(filteredGraphs);
    ...
    public void shouldThrowException() throws Exception {
        ...
        Mockito.when(mockStore.getGraphs(user, TEST_GRAPH_ID, null)).thenReturn(filteredGraphs);
