...
import gaffer.function.ProducerFunction;
import gaffer.function.Tuple;
import java.util.Arrays;
import java.util.List;

/**
 * A <code>ProducerFunctionContext</code> wraps a {@link gaffer.function.ProducerFunction}, and provides the
 * references to project the results produced by a function into an output {@link gaffer.function.Tuple}.
 *
...
public class ProducerFunctionContext<R, F extends ProducerFunction> extends FunctionContext<F> {
     ...
     * {@link gaffer.function.ProducerFunction} into output {@link gaffer.function.Tuple}s using the specified
     * projection references.
     *
     * @param function   {@link gaffer.function.ProducerFunction} to be wrapped by the context.
    ...
    /**
     * @return References to project data into an output {@link gaffer.function.Tuple}.
     */
    ...
    /**
     * @param projection References to project data into an output {@link gaffer.function.Tuple}.
     */
    ...
    /**
     * Implementation of the Builder pattern for {@link gaffer.function.context.ProducerFunctionContext}.
     *
    ...
    public static class Builder<R, F extends ProducerFunction> extends FunctionContext.Builder<F> {
        ...
        /**
         * Create a <code>Builder</code> to configure a new {@link gaffer.function.context.ProducerFunctionContext}.
         */
        public Builder() {
        ...
        /**
         * Create a <code>Builder</code> to configure a {@link gaffer.function.context.ProducerFunctionContext}.
         *
         * @param context {@link gaffer.function.context.ProducerFunctionContext} to be configured.
         */
        ...
        /**
         * Sets the references to be used by the {@link gaffer.function.context.ProducerFunctionContext} to project
         * output data and returns this <code>Builder</code> for further configuration.
         *
         * @param newProjection References to project data into an output {@link gaffer.function.Tuple}.
