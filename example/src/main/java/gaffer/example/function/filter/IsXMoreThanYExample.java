...
import gaffer.function.simple.filter.IsXMoreThanY;

public class IsXMoreThanYExample extends FilterFunctionExample {
    ...
    public void isXMoreThanY() {
        runExample(new IsXMoreThanY(),
                "new IsXMoreThanY()",
                new Comparable[]{1, 5},
                new Comparable[]{5, 5},
                new Comparable[]{10, 5},
                new Comparable[]{10L, 5},
                new Comparable[]{1L, 5L},
                new Comparable[]{5L, 5L},
                new Comparable[]{10L, 5L},
                new Comparable[]{10, 5L},
