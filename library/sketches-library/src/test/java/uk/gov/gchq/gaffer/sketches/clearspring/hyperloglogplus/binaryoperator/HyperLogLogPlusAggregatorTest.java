 ...
 */
package uk.gov.gchq.gaffer.sketches.clearspring.hyperloglogplus.binaryoperator;
...
public class HyperLogLogPlusAggregatorTest extends BinaryOperatorTest {
    ...
    public void shouldJsonSerialiseAndDeserialise() throws SerialisationException {
        ...
        JsonAssert.assertEquals(String.format("{%n" +
                "  \"class\" : \"uk.gov.gchq.gaffer.sketches.clearspring.hyperloglogplus.binaryoperator.HyperLogLogPlusAggregator\"%n" +
                "}"), json);
