...
public class KoryphePredicateFactory {
     ...
     /**
      * Converts a BiPredicate from a Tinkerpop HasContainer to a KoryphePredicate
      * that can be serialised in a Gaffer View
      *
      * @param p the predicate to convert
      * @param value the value to compare against
      * @return the equivalent KoryphePredicate
      */
     public Predicate<?> getKoryphePredicate(final P<?> p, final Object value) {
     ...
     private Or<?> getOrPredicate(final OrP<?> orP) {
     ...
     private And<?> getAndPredicate(final AndP<?> andP) {
