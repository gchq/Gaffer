...
package uk.gov.gchq.gaffer.data.element.function.koryphe;
...
public class KorypheElementFilterTest {

    @Test
    public void shouldTestElementOnPredicate2() {
        // Given
        final KorypheElementFilter filter = new KorypheElementFilter.Builder()
                .select("prop1", "prop2")
