...
/**
 * An <code>LazyEntity</code> wraps an {@link gaffer.data.element.Entity} and lazily loads the identifier and properties when
 * requested using a provided {@link gaffer.data.element.ElementValueLoader}. This will avoid loading all of an
...
public class LazyEntity extends Entity {
    ...
    /**
     * Constructs a {@link gaffer.data.element.LazyEntity} by wrapping the provided {@link gaffer.data.element.Entity}
     * and using the {@link gaffer.data.element.ElementValueLoader} to lazily load the element's identifiers and
