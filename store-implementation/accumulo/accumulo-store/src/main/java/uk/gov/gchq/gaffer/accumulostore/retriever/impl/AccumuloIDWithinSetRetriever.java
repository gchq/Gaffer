...
/**
 * Retrieves {@link Edge}s where both ends are in a given
 * set of {@link EntityId}'s and
 * {@link Entity}s where the vertex is in the set.
 * <p>
 * {@link BloomFilter}s are used to identify on the
 ...
 * {@link BloomFilter}. This is passed to the
 ...
 * i.e. edges that passed the {@link BloomFilter}
 ...
 * for, a {@link BloomFilter} of the first batch is
 ...
 * queried for, the same {@link BloomFilter} has
 ...
 * {@link BloomFilter} to further reduce the
