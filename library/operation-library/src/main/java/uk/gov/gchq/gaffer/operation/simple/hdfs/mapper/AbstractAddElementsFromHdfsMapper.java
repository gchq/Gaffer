 ...
 */
package uk.gov.gchq.gaffer.operation.simple.hdfs.mapper;
...
import uk.gov.gchq.gaffer.operation.simple.hdfs.handler.job.factory.AddElementsFromHdfsJobFactory;
 ...
 * {@link uk.gov.gchq.gaffer.data.element.Element}s and then delegates the elements to an abstract map method to serialise them
