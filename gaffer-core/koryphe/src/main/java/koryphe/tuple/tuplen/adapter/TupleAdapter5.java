...
/**
 * A {@link TupleAdapter} that refers to 5 values in the wrapped tuple.
 ...
 */
public class TupleAdapter5<A, B, C, D, E, R> extends TupleAdapter4<A, B, C, D, R> implements Tuple5<A, B, C, D, E> {
    public TupleAdapter5(final TupleAdapter<R, A> first, final TupleAdapter<R, B> second, final TupleAdapter<R, C> third, final TupleAdapter<R, D> fourth, final TupleAdapter<R, E> fifth) {
        super(first, second, third, fourth, fifth);
    }

    public TupleAdapter5() { }

    protected TupleAdapter5(final TupleAdapter<R, ?>... references) {
        super(references);
    }
