...
/**
 * {@link ISchemaLoader} implementation to load fully featured {@link uk.gov.gchq.gaffer.store.schema.Schema}s
 * for testing purposes.
 */
public class FullSchemaLoader implements ISchemaLoader {
