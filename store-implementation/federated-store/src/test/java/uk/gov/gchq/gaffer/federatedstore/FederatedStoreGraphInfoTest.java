...
public class FederatedStoreGraphInfoTest {
    ...
    public void shouldGetInfoForGraphId() throws Exception {
        ...
        // When / Then
        assertThat(results)
                .containsOnlyKeys(Arrays.asList(GRAPH_ID_A));
    }

    @Test
    public void shouldNotGetInfoForExcludedGraphId() throws Exception {
        // Given
        Map<String, Object> results = federatedStore.execute(
                new GetAllGraphInfo.Builder()
                        .excludedGraphIdsCSV(GRAPH_ID_A)
                        .build(), contextBlankUser());

        // When / Then
        assertThat(results)
                .containsOnlyKeys(Arrays.asList(GRAPH_ID_B));
    }


    @Test
    public void shouldNotGetInfoForWhiteListWhileAlsoIsExcluded() throws Exception {
        // Given
        Map<String, Object> results = federatedStore.execute(
                new GetAllGraphInfo.Builder()
