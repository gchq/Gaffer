...
public class SumHandler implements OutputOperationHandler<Sum, Long> {
    @Override
    public Long doOperation(final Sum operation, final Context context, final Store store) throws OperationException {
