 ...
 * <p>
 * <p>
 * If the {@code gaffer.accumulo.spark.directrdd.use_rfile_reader} option is set to {@code true} then the
...
public class GetRDDOfAllElementsHandler extends AbstractGetRDDHandler<GetRDDOfAllElements, RDD<Element>> {
    ...
    private RDD<Element> doOperation(final GetRDDOfAllElements operation,
            ...
            throws OperationException {
        final SparkSession sparkSession = SparkContextUtil.getSparkSession(context, accumuloStore.getProperties());
