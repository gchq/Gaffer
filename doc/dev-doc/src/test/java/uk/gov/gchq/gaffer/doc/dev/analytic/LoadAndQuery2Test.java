...
import uk.gov.gchq.gaffer.doc.dev.walkthrough.QueryForAGroup;
...
public class LoadAndQuery2Test {
    private static final String RESOURCE_EXAMPLE_PREFIX = "2/";
    ...
    public void shouldReturnExpectedEdges() throws OperationException {
        // Given
        final QueryForAGroup query = new QueryForAGroup();
