...
public abstract class NumericAggregateFunction extends SimpleAggregateFunction<Number> {
     ...
     *
     * @param mode the {@link uk.gov.gchq.gaffer.function.simple.aggregate.NumericAggregateFunction.NumberType} to set.
     */
    ...
    /**
     * @return the {@link uk.gov.gchq.gaffer.function.simple.aggregate.NumericAggregateFunction.NumberType} to be aggregated
     */
