...
public class TimestampSet extends PropertiesWalkthrough {
    public TimestampSet() {
        super("Using a TimestampSet to records the set of timestamps an element was active", "properties/timestampSet",
    ...
    public CloseableIterable<? extends Element> run() throws OperationException {
        ...
        // ---------------------------------------------------------
        log("Added an edge A-B 1000 times, each time with a RBMBackedTimestampSet containing a random time in 2017.");
