...
public class ReservoirNumbersUnionKryoSerializerTest extends KryoSerializationTest<ReservoirItemsUnion<Number>> {
    ...
    @Override
    public ReservoirItemsUnion<Number> getTestObject() {
