...
public class AbstractWalkthroughRunner {
    ...
    public AbstractWalkthroughRunner(final List<Class<? extends AbstractWalkthrough>> examples, final String modulePath) {
    ...
    private void printIntro() {
        final String intro;
        try (final InputStream stream = StreamUtil.openStream(getClass(), "/walkthrough/intro.md")) {
