 ...
 * {@link gaffer.data.element.Element} is an instance of an {@link gaffer.data.element.Entity}.
 */
public class IsEntityValidator implements Validator<Element> {
     ...
     * @return true if the {@link gaffer.data.element.Element} is an instance of an {@link gaffer.data.element.Entity}.
     */
    @Override
