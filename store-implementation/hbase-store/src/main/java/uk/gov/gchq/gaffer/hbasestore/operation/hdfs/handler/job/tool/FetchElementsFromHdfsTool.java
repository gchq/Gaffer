 ...
 */
package uk.gov.gchq.gaffer.hbasestore.operation.hdfs.handler.job.tool;
...
public class FetchElementsFromHdfsTool extends Configured implements Tool {
    ...
    public FetchElementsFromHdfsTool(final AddElementsFromHdfs operation, final HBaseStore store) {
    ...
    public int run(final String[] strings) throws Exception {
        ...
        final Job job = new HBaseAddElementsFromHdfsJobFactory().createJob(operation, store);
