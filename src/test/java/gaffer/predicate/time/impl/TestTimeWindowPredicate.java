...
/**
 * Unit tests for {@link TimeWindowPredicate}. Contains tests for writing and reading,
 * equals and accept.
 */
public class TestTimeWindowPredicate {
    ...
    public void testWriteRead() throws IOException {
        TimeWindowPredicate predicate = new TimeWindowPredicate(sevenDaysBefore, sixDaysBefore);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        DataOutputStream out = new DataOutputStream(baos);
        predicate.write(out);
        ByteArrayInputStream bais = new ByteArrayInputStream(baos.toByteArray());
        DataInputStream in = new DataInputStream(bais);
        TimeWindowPredicate read = new TimeWindowPredicate();
        read.readFields(in);
    ...
    public void testAccept() {
        ...
        predicate = new TimeWindowPredicate(sixDaysBefore, fiveDaysBefore);
        assertFalse(predicate.accept(sevenDaysBefore, sevenDaysBefore));
        assertTrue(predicate.accept(sixDaysBefore, fiveDaysBefore));
    }

    @Test
    public void testEquals() {
        TimeWindowPredicate predicate1 = new TimeWindowPredicate(sevenDaysBefore, sixDaysBefore);
        TimeWindowPredicate predicate2 = new TimeWindowPredicate(sevenDaysBefore, sixDaysBefore);
        assertEquals(predicate1, predicate2);
        predicate2 = new TimeWindowPredicate(sevenDaysBefore, fiveDaysBefore);
