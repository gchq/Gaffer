...
public class UnrestrictedAccessPredicate extends AccessPredicate {
    ...
    public boolean equals(final Object o) {
        ...
        final UnrestrictedAccessPredicate that = (UnrestrictedAccessPredicate) o;

        return new EqualsBuilder()
                .append(unrestrictedAccess, that.unrestrictedAccess)
    ...
    public String toString() {
        return new ToStringBuilder(this)
                .append("unrestrictedAccess", unrestrictedAccess)
                .append("auths", auths)
                .toString();
    }
