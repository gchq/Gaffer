...
public class GetAllElementsIT extends AbstractStoreIT {
    ...
    protected void shouldGetAllElements(final boolean includeEntities, final boolean includeEdges, final DirectedType directedType, Graph graph) throws Exception {
        // Given
