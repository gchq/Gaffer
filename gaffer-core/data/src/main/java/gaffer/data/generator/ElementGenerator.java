...
public interface ElementGenerator<OBJ> {
     ...
     * @return an {@link java.lang.Iterable} of {@link gaffer.data.element.Element}
     */
    Iterable<Element> getElements(final Iterable<OBJ> domainObjects);

    /**
     * @param elements an {@link java.lang.Iterable} of {@link gaffer.data.element.Element}s to convert
