...
public class StoreProperties implements Cloneable {
    ...
    public static final String STORE_CLASS = "uk.gov.gchq.gaffer.store.class";
    public static final String SCHEMA_CLASS = "uk.gov.gchq.gaffer.store.schema.class";
    public static final String STORE_PROPERTIES_CLASS = "uk.gov.gchq.gaffer.store.properties.class";
    public static final String OPERATION_DECLARATIONS = "uk.gov.gchq.gaffer.store.operation.declarations";
