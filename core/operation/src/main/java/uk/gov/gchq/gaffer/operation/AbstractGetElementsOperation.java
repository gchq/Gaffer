...
public abstract class AbstractGetElementsOperation<SEED_TYPE, RESULT_TYPE>
    ...
    protected AbstractGetElementsOperation(final Iterable<SEED_TYPE> seeds) {
        this(new WrappedCloseableIterable<>(seeds));
    }

    protected AbstractGetElementsOperation(final CloseableIterable<SEED_TYPE> seeds) {
        super(seeds);
    }

    protected AbstractGetElementsOperation(final View view) {
        super(view);
    }

    protected AbstractGetElementsOperation(final View view, final Iterable<SEED_TYPE> seeds) {
        this(view, new WrappedCloseableIterable<>(seeds));
    }

    protected AbstractGetElementsOperation(final View view, final CloseableIterable<SEED_TYPE> seeds) {
        super(view, seeds);
    }
    ...
    public abstract static class BaseBuilder<
            OP_TYPE extends AbstractGetElementsOperation<SEED_TYPE, RESULT_TYPE>,
            SEED_TYPE,
            RESULT_TYPE,
            CHILD_CLASS extends BaseBuilder<OP_TYPE, SEED_TYPE, RESULT_TYPE, ?>
            >
            extends AbstractGetOperation.BaseBuilder<OP_TYPE, SEED_TYPE, RESULT_TYPE, CHILD_CLASS> {
    ...
    public static final class Builder<OP_TYPE extends AbstractGetElementsOperation<SEED_TYPE, RESULT_TYPE>, SEED_TYPE, RESULT_TYPE>
