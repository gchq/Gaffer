...
/**
 * For new properties use {@link uk.gov.gchq.gaffer.types.serialisation.implementation.ordered.OrderedLongSerialiser}.
 * RawLongSerialiser serialises Longs into a little-endian byte array.
 *
 * @deprecated this is unable to preserve object ordering.
 * @see uk.gov.gchq.gaffer.types.serialisation.implementation.ordered.OrderedLongSerialiser
 */
@Deprecated
