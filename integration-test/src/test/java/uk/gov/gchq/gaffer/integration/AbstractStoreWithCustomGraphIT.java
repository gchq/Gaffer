...
public abstract class AbstractStoreWithCustomGraphIT {
    ...
    public static void setStoreProperties(final StoreProperties storeProperties) {
        AbstractStoreWithCustomGraphIT.storeProperties = storeProperties;
    }
    ...
    public static void setStoreSchema(final Schema storeSchema) {
        AbstractStoreWithCustomGraphIT.storeSchema = storeSchema;
    }

    public static void setSkipTests(final Map<? extends Class<? extends AbstractStoreWithCustomGraphIT>, String> skippedTests) {
        AbstractStoreWithCustomGraphIT.skippedTests = skippedTests;
    }

    public static void setSingleTestMethod(final String singleTestMethod) {
        AbstractStoreWithCustomGraphIT.singleTestMethod = singleTestMethod;
    }

    public static void setSkipTestMethods(final Map<? extends Class<? extends AbstractStoreWithCustomGraphIT>, Map<String, String>> skipTestMethods) {
