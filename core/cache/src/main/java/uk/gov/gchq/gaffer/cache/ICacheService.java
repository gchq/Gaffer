...
/**
 * The uk.gov.gchq.gaffer.cache service interface which enables the uk.gov.gchq.gaffer.cache service loader to instantiate any service no matter the
 * implementation. All services should be able to provide a uk.gov.gchq.gaffer.cache and methods to interact with it.
 *
 */
