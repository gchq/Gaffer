...
public class FullExample extends UserWalkthrough {
    ...
    public Iterable<? extends String> run() throws OperationException {
        ...
        // [get] Get all road junctions in the South West that were heavily used by buses in year 2000.
        // ---------------------------------------------------------
                ...
                .then(new GetElements.Builder()
                        .view(new View.Builder()
                                ...
                                .entity("JunctionUse", new ViewElementDefinition.Builder()
                                        ...
                                        // Extract the bus count out of the frequency map
                        ...
                        .build())
                // Convert the result entities to a simple CSV of Junction and busCount.
    ...
    protected InputStream getData() {
        return StreamUtil.openStream(DemoData.class, "roadTrafficSampleData.csv");
    }

    @Override
    protected InputStream[] getSchemas() {
        return StreamUtil.schemas(ElementGroup.class);
    }
