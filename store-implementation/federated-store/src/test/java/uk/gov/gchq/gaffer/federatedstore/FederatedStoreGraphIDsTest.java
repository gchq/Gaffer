...
public class FederatedStoreGraphIDsTest {
    ...
    @Test
    public void shouldNotSelectBlackListGraphUsingFederatedOperation() throws Exception {
        // Given
        Iterable results = (Iterable) federatedStore.execute(
                new FederatedOperation.Builder()
                        .op(new GetAllElements())
                        .blackListGraphIdsCSV(GRAPH_ID_B)
                        .build(), contextBlankUser());
    ...
    @Test
    public void shouldNotSelectWhiteListGraphWhileInBlackListUsingFederatedOperation() throws Exception {
        // Given
        Iterable results = (Iterable) federatedStore.execute(
                new FederatedOperation.Builder()
                        .op(new GetAllElements())
